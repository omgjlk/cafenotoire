...
class ReviewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reviewer" do
    assert_difference('Reviewer.count') do
      post reviewers_url, params: { reviewer: { location: @reviewer.location, name: @reviewer.name } }
    end
  ...
  test "should update reviewer" do
    patch reviewer_url(@reviewer), params: { reviewer: { location: @reviewer.location, name: @reviewer.name } }
