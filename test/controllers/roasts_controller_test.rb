...
class RoastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roast" do
    assert_difference('Roast.count') do
      post roasts_url, params: { roast: { name: @roast.name, roaster_id: @roast.roaster_id } }
    end
  ...
  test "should update roast" do
    patch roast_url(@roast), params: { roast: { name: @roast.name, roaster_id: @roast.roaster_id } }
